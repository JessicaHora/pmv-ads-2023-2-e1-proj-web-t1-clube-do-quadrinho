...
|:---|:---|
| Requisitos Associados | RF-06:	O sistema deve permitir ao usuário visualizar as informações dos quadrinhos. 
...
|:---|:---|
| Requisitos Associados | RF-05:	O sistema deve permitir ao usuário registrar quadrinhos como lidos, lendo e a ler.  |
...
|:---|:---|
| Requisitos Associados | RF-10:	O sistema deve permitir o usuário adicionar quadrinhos à listas criadas. |
